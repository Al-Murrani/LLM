...
<body>
    <h1 style="text-align:center; color:#4CAF50;">Pre-processing data for LLM</h1>
	...
	https://docs.unstructured.io/welcome
		...
		Hybrid search semantic search and filtering on metadata
    </p>

    <h2>Document analysis to normalise output</h2>
    <ul>
        <li>Detect</li>
        <li>Chunk</li>
		<p>
		1.
			...
			Chunk Rules:
				structure On tags (h1, p), unstructured data such as single sentence in a p tag that is capital is more like to be a 
			title
